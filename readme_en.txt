...
have the letter. (But it is not directly proportional exactly.)
...
+ If you have found a bug or you have a sugguestion, please visit
  TELKLAND(https://telk.kr) or email to TELK(telk5093@gmail).
+ If you want to translate Korean Train Set and the download page of Korean Train Set
  into your language, please visit the Github project(https://github.com/KoreanGRF/KoreanTownNames)
...
6. Credits
==========
TELK (telk5093@gmail.com, https://telk.kr)
  - NML Codes
